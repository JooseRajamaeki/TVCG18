...
//Added by Perttu: define ODECAUSAL to enable changes that try to make simulation fully causal, i.e., replayable. See: http://ode-wiki.org/wiki/index.php?title=HOWTO_save_and_restore 
#define ODECAUSAL
