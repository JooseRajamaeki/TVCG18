...
/**
 * @brief Same as dBodySetQuaternion, but without normalization. Used in saving and restoring state precisely. 
 * @ingroup bodies
 */
ODE_API void dBodySetQuaternionWithoutNormalization (dBodyID, const dQuaternion q);
...
/**
 * @brief Get the current hinge angle for given body rotations
 * @remarks
 * Not implemented in dAMotorUser mode
 * @ingroup joints
 */
ODE_API dReal dJointGetHingeAngleFromBodyRotations(dJointID, const dQuaternion q1, const dQuaternion q2);
...
/**
 * @brief Get the current motor angles for given body rotations
 * @remarks
 * Not implemented in dAMotorUser mode
 * @ingroup joints
 */
ODE_API void dJointGetAMotorAnglesFromBodyRotations(dJointID, const dQuaternion q1, const dQuaternion q2, dVector3 out_angles);
